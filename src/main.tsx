...
import SwordsPage from './pages/weapons/two-handed/SwordsPage.tsx'
	...
	<StrictMode>
		<BrowserRouter>
			<Routes>
				...
				<Route path="weapons/twohanded/swords/:weaponsDetails" element={<WeaponsDetails />} />
				<Route path="weapons/legendary/:weaponsDetails" element={<WeaponsDetails />} />

				<Route path="weapons/twohanded/axes" element={<AxesPage />} />
				<Route path="weapons/twohanded/swords" element={<SwordsPage />} />
