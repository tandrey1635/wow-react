...
import dataTwoHandedSwords from '../json/weapons/two-handed/swords/swords.json';

import dataTwoHandedAxesWeaponDetails from '../json/weapons/two-handed/axes/axes-details.json';
import dataTwoHandedSwordsWeaponDetails from '../json/weapons/two-handed/swords/swords-details.json';
		...
		<section className="services">
			<div className="container">
				<div className="nav__wrapper">
								...
								<Tabs defaultActiveKey="weapons" id="cards-tabs" fill>
									<Tab eventKey="weapons" title="Оружие">
										<ul style={{left: 0}} className="nav-menu nav-menu-dropdown nav-menu-weapons">
											<Link className="nav-link nav-link-weapons" to="/weapons/twohanded/">Двуручное</Link>
											<Link className="nav-link nav-link-weapons" to="/weapons/twohanded/swords">Двуручные мечи</Link>
										</ul>
									</Tab>
								</Tabs>
							...
							<>
								<Tabs defaultActiveKey="weapons" id="cards-tabs" fill>
									<Tab eventKey="weapons" title="Оружие">
										<ul style={{left: 0}} className="nav-menu nav-menu-dropdown nav-menu-weapons">
											<Link className="nav-link nav-link-weapons" to="/weapons/twohanded/">Двуручное</Link>
											<Link className="nav-link nav-link-weapons" to="/weapons/twohanded/axes">Двуручные топоры</Link>
										</ul>
									</Tab>
								</Tabs>
								<h3 className="text-success text-center fw-bold display-4">Всего Оружия: {counterCardItems(dataTwoHandedSwordsWeaponDetails)}</h3>
								<div className="card-box d-flex flex-wrap justify-content-center justify-content-xl-start mt-4">
									{ renderCardItems(dataTwoHandedSwords) }
								</div>
							</>
						}
					</>
					...
					{ twoHandedSwordsWeaponDetails &&
						<div className="card-box d-flex flex-wrap justify-content-center justify-content-xl-start">
							{ renderWeaponDetails(dataTwoHandedSwordsWeaponDetails) }
						</div>
					}
