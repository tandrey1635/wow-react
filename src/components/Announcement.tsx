					...
					<h1
						className={`${
							...
							rangeWeapons
								...
								:
							legendaryWeapons || ashbringer || sulfuras || thunderfury || atiesh || warglaivesOfAzzinoth || thoridal || valanyr || shadowmourne || tarecgosa
