...
const AhnqirajTemple = ()=> {
	const audioSrc = "/src/assets/sounds/raids-armours/ahnqiraj-temple.mp3"
	...
	return (
		<Wrapper>
			...
			<Main>
				...
				<h2 className="text-center text-info lh-1" style={{fontSize: 48}}>Храм Ан'Киража</h2>
				<p className="my-4 text-center text-success fw-bold fs-4">Нажмите на картинку чтобы воспроизвести звук</p>
				<div className="d-flex flex-column justify-content-center align-items-center">
					<img style={{width: 360}} src="/src/assets/img/raids-armours/bg/details-page/ahnqiraj-temple.png" alt="" onClick={play} onMouseLeave={pause} onMouseEnter={play} />
