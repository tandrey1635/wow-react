...
const Ulduar = ()=> {
	const audioSrc = "/src/assets/sounds/raids-armours/ulduar.mp3"
	...
	return (
		<Wrapper>
			...
			<Main>
				...
				<h2 className="text-center text-info lh-1" style={{fontSize: 48}}>Осада Ульдуара</h2>
				...
				<div className="d-flex flex-column justify-content-center align-items-center">
					<img style={{width: 360}} src="/src/assets/img/raids-armours/bg/details-page/ulduar.png" alt="" onClick={play} onMouseLeave={pause} onMouseEnter={play} />
