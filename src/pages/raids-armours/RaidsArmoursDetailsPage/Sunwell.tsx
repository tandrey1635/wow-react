...
const Sunwell = ()=> {
	const audioSrc = "/src/assets/sounds/raids-armours/sunwell.mp3"
	...
	return (
		<Wrapper>
			...
			<Main>
				...
				<h2 className="text-center text-info lh-1" style={{fontSize: 48}}>Плато Солнечного Колодца</h2>
				...
				<div className="d-flex flex-column justify-content-center align-items-center">
					<img style={{width: 360}} src="/src/assets/img/raids-armours/bg/details-page/sunwell.png" alt="" onClick={play} onMouseLeave={pause} onMouseEnter={play} />
